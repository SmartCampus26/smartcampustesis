...
export const homeAutoridadStyles = StyleSheet.create({
  ...
  reportCard:         { backgroundColor: '#FFFFFF', padding: 16, borderRadius: 12, marginBottom: 12, elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 2 },
  reportHeader:       { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  reportId:           { fontSize: 16, fontWeight: 'bold', color: '#2F455C' },
  statusBadge:        { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 12 },
  statusText:         { color: '#FFFFFF', fontSize: 12, fontWeight: '600', textTransform: 'capitalize' },
  reportDesc:         { fontSize: 14, color: '#2F455C', marginBottom: 12, lineHeight: 20 },
  ...
  reportDate:         { fontSize: 12, color: '#8B9BA8' },
  priorityContainer:  { flexDirection: 'row', alignItems: 'center', gap: 4 },
  reportPriority:     { fontSize: 12, fontWeight: '600', textTransform: 'capitalize' },
  tipsCard:           { margin: 16, marginTop: 8, padding: 20, backgroundColor: '#FFF9E6', borderRadius: 16, borderLeftWidth: 4, borderLeftColor: '#FFA726' },
  tipsHeader:         { flexDirection: 'row', alignItems: 'center', marginBottom: 12, gap: 8 },
  tipsTitle:          { fontSize: 16, fontWeight: 'bold', color: '#2F455C' },
  tipsText:           { fontSize: 14, color: '#2F455C', lineHeight: 20 },
