// src/services/admin/TodosReportesService.ts
// Servicios de datos para la pantalla TodosReportes (vista de autoridad).
//
// Responsabilidades:
//   - Cargar todos los usuarios y reportes del sistema
//   - Filtrar reportes en memoria por búsqueda, rol y estado
//   - Eliminar reportes (acción exclusiva de autoridades)
//   - Helpers de color y texto para estado y prioridad
 ...
 * Los reportes incluyen usuario, empleado asignado, objeto y lugar
 * (objeto viene como array desde Supabase y se normaliza a objeto singular).
 */
export const cargarDatosTodosReportes = async (): Promise<{
  ...
  // objeto viene como ARRAY desde Supabase — normalizar y buscar lugar
 ...
 * Primero elimina el objeto (tiene FK hacia reporte) y luego el reporte.
 * Esta operación es exclusiva de autoridades.
 *
...
/**
 * Filtra la lista de reportes en memoria según búsqueda de texto,
 * rol del creador y estado del reporte.
 */
